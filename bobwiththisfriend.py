...
if password == "bob" and username == "King":
    print ("Entered as KingBob")
    time.sleep(2)
...
def attack(ip, port, time, threads):
    ...
    print(brand)
    print("\033[92m ★★★★ KingBob With Friend ★★★★")
    fmt = '\033[91m KingBob Has Sending Attack To ===> Ip {ip}, Port {port}'.format(
        ip=ip,
